...
\begin{figure}[ht]
\centering
\includegraphics[width=0.8\textwidth]{accuracy_vs_dimension}
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.8\textwidth]{accuracy_vs_prior_5_5_5}
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.8\textwidth]{Accuracy_VS_Prior_mean.eps}
