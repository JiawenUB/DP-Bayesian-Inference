...
Fig. \ref{subfig_concrete_prob_2d} and \ref{subfig_concrete_prob_3d} gives us the concrete probabilities of outputting candidates with certain Hellinegr distance from the correct posterior in 2 and 3 respectively.
\begin{figure}[H]
\begin{center}
\centering
   \subfigure[2 dimensions with data size $100$]{
    \includegraphics[width=0.317\textwidth]{poster_6.eps}
  \label{subfig_prior}
  }
