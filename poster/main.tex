...
\noindent Design a tool for differentially private probabilistic
programming featuring:
\begin{enumerate}
\item programming constructs to describe bayesian models and perform probabilistic inference,
\item programming constructs useful to ensure differential privacy,
\item type-checking as a method to ensure that the actual programs are
...
\centering
  \subfigure[Data set size from $300$ to $800$ ]{
    \includegraphics[width=0.39\textwidth]{poster_1.eps}
    \label{fig_1}
  }
  \subfigure[Data set size from $14000$ to $20000$]{
    \includegraphics[width=0.352\textwidth]{poster_2.eps}
...
\centering
  \subfigure[Data set size from $300$ to $800$ ]{
    \includegraphics[width=0.372\textwidth]{poster_3.eps}
    \label{subsubsec_vs_datasize1a}
  }
  \subfigure[Data set size from $14000$ to $20000$]{
    \includegraphics[width=0.32\textwidth]{poster_4.eps}
  \label{subsubsec_vs_datasize1b}} 
\caption{Increasing data size with fixed prior $\betad(1,1)$. Unbalanced datasets of mean $(0.1,0.9)$ and parameters $\epsilon = 0.8$ and $\delta = 10^{-8}$}
\label{fig_vs_datasize}
\end{center}
