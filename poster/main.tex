...
\item Applying smooth sensitivity in mechanism to achieve better accuracy. This is motivated by Fig. \ref{fig_sensitivity} that local sensitivity is very steep in edge but very smooth in center part.
\end{enumerate}
\end{column}
