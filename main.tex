...
As shown in Fig. \ref{fig_theory_50_50}, our exponential mechanism is better than Laplace, both in experiments and in theory. In Fig. \ref{fig_theory_50_50} (a), the experiment results shown that the average accuracy of our mechanism is better than Laplace mechanism. In Our exponential mechanism can output good answer with higher probability and output bad answer with lower probability.
...
In Fig. \ref{fig_theory_20_20_20}, we plotted these discrete probabilities under the case (x=(20,20,20)),  I think this plot shows the laplace mech performs better than ExpMech to some extent but not significant.
