...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item keep the prior unchanged, $\betad(1,1,1)$, the observed data set $x = (20,20)$ (suppose a black box will produce $A$, $B$ with a certain distribution, after observing this black box continuously for 60 times, we get $20$ times $A$ and $20$ times $B$, we can get the posterior distribution $\betad(21,21)$
...
We studied the local sensitivity of hellinger distance of different $\betad$ distributions first as in Fig. \ref{fig_sensitivity}, in order to better understand the relationships between accuracy and next two aspects.
