...
\begin{thm}
 ...
 Then, by combination and permutation, there are $\frac{k! k!}{|a_1|! |a_2|! \cdots |a_{k_a}|! \cdot |b_1|! |b_2|! \cdots |b_{k_b}|!}$ possible combination that satisfy the condition in Theorem \ref{thm_hellinegr_equality_dirichlet}.
 \end{proof}
