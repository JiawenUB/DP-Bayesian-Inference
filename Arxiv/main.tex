...
\label{lem_score_pro_eq}
  Given $\hexpmech(\dataobs)$ and $r', r'' \in \candidateset{\dataobs}$, then following holds:
  $$
  \ux{r'} = \ux{r''} \iff \hexpmechPr{\dataobs}{z = r'} = \hexpmechPr{\dataobs}{z = r''}.
  $$  
\end{lem}
...
\begin{itemize}
  ...
  & \implies \hellinger(\bysinfer(\dataobs), r') = \hellinger(\bysinfer(\dataobs), r'') \\
  & \implies \frac {exp\big(\frac{-\epsilon\cdot\hellinger(\bysinfer(\dataobs),r')}{2\cdot S(\dataobs)}\big)}{\nomalizer{\dataobs}} 
  = \frac {exp\big(\frac{-\epsilon\cdot\hellinger(\bysinfer(\dataobs),r'')}{2\cdot S(\dataobs)}\big)}{\nomalizer{\dataobs}}\\
  & Apply\ Definition\ \ref{def_smoo} :\\
  & \implies \hexpmechPr{\dataobs}{z = r'} = \hexpmechPr{\dataobs}{z = r''}.
  \end{split}
  \end{equation*}
  ...
  \item $\impliedby$
    ...
    \begin{equation*}
  \begin{split}
  & \hexpmechPr{\dataobs}{z = r'} = \hexpmechPr{\dataobs}{z = r''} \\
  & Apply\ Definition\ \ref{def_smoo} :\\
  & \implies \frac {exp\big(\frac{-\epsilon\cdot\hellinger(\bysinfer(\dataobs),r')}{2\cdot S(\dataobs)}\big)}{\nomalizer{\dataobs}} 
  = \frac {exp\big(\frac{-\epsilon\cdot\hellinger(\bysinfer(\dataobs),r'')}{2\cdot S(\dataobs)}\big)}{\nomalizer{\dataobs}}\\
  & \implies  \hellinger(\bysinfer(\dataobs), r') = \hellinger(\bysinfer(\dataobs), r'') \\
...
\label{def_cardinality}
  ...
  Define $\cardinality{r}$ as the cardinality of $R_r$ s.t. $ R_r = \{ r' | r' \in \candidateset{\dataobs}\ s.t. \ \ux{r'} = \ux{r}, \}$ and $\forall \hat{r} \in \candidateset{\dataobs}, \hat{r} \notin R_r \implies \ux{\hat{r}} \neq \ux{r}$, 
\end{definition}
...
\begin{equation*}
\hexpmechPr{\dataobs}{\ux{z} = \ux{r}} = \cardinality{r}\hexpmechPr{\dataobs}{z = r}
 \end{equation*}
\end{lem}
\begin{proof} of Lemma \ref{lem_score_pro_convert}.\\
To compute $\hexpmechPr{\dataobs}{\ux{z} = \ux{r}}$\\
$\iff $ to compute $\hexpmechPr{\dataobs}{ R | R = \{r' | r' \in \candidateset{\dataobs} \land \ux{r'} = \ux{r}\}}.$\\
By Definition \ref{def_cardinality}, $R_r$ is this set.\\
$\implies \hexpmechPr{\dataobs}{\ux{z} = \ux{r}} = \hexpmechPr{\dataobs}{R_r} $.\\
By the independence of $r' \in R_r$, $ \hexpmechPr{\dataobs}{z \in R_r}  =\sum\limits_{r'\in R_r} \hexpmechPr{\dataobs}{z = r'}$ ,\\
Apply Lemma \ref{lem_score_pro_eq} in $R_r$, \\
$\implies$ for any $r', r''\in R_r$, $\hexpmechPr{\dataobs}{z = r'} = \hexpmechPr{\dataobs}{z = r''}$.\\
$\implies$ $\sum\limits_{r'\in R_r} \hexpmechPr{\dataobs}{z = r'} = \cardinality{r}\hexpmechPr{\dataobs}{z = r}$.\\
$\implies$ $\hexpmechPr{\dataobs}{\ux{z} = \ux{r}} = \cardinality{r}\hexpmechPr{\dataobs}{z = r}$.\\
\end{proof}
...
Given $\hexpmech(\dataobs)$ calibrated on the smooth sensitivity. In Beta-binomial system, let $\epsilon\geq 0$ and $\ux{r} + k >=0$. Then, the following \emph{sliding property} holds:
\begin{equation*}
...
In Beta-binomial system, $\cardinality{r}$ takes two possible value: $1$, $2$:
\begin{itemize}
  \item[-] $\cardinality{r} = 1$, $\ux{r} = 0$,  containing only the correct posterior.
  \item[-] $\cardinality{r} = 2$, $\ux{r} \neq 0$. $R_r$ containing 2 elements by the symmetry property of $\hellinger$.
\end{itemize}

\todo{
In Beta-binomial system, $\cardinality{r}$ takes two possible value: $1$, $2$. Let $\mathcal{R}_1$, $\mathcal{R}_2$ be a partition of $\candidateset{\dataobs}$:
\begin{itemize}
  \item[*] $\mathcal{R}_1 = \{r | r \in \candidateset{\dataobs}\ s.t.\ \cardinality{r} = 1\}$.
  \item[*] $\mathcal{R}_2 = \{r | r \in \candidateset{\dataobs}\ s.t.\ \cardinality{r} = 2\}$.
\end{itemize}
}
...
\begin{itemize}
  ...
  By $\ux{r} + k \neq 0$, $\cardinality{t} = 2$. \todo{By $t \in \mathcal{R}_2$, $\cardinality{t} = 2$}\\
  By $\ux{r} \neq 0 $, $\cardinality{r} = 2$. \todo{By $r \in \mathcal{R}_2$, $\cardinality{r} = 2$}\\
  Destruct k:
  \begin{itemize}
    \item  $k \geq 0$: $\implies$\\
      ...
      \begin{split}
      LHS 
      & = \cardinality{r} \cdot \hexpmechPr{\dataobs}{z = r}     (Apply\ Lemma\ \ref{lem_score_pro_convert})\\
      & = \cardinality{r} \cdot \frac {exp\big(\frac{-\epsilon\cdot\hellinger(\bysinfer(\dataobs),r)}{2\cdot S(\dataobs)}\big)}{\nomalizer{\dataobs}} 
      (Apply\ Definition\ \ref{def_smoo})\\
      & = \cardinality{r} \cdot \frac{exp(\frac{-\epsilon \ux{r}}{2 S(\dataobs)})}{\unomalizer{\dataobs}}
      (Apply\ \ux{r} = \hellinger(\bysinfer(\dataobs), r))\\
      & = 2 \cdot \frac{exp(\frac{-\epsilon \ux{r}}{2 S(\dataobs)})}{\unomalizer{\dataobs}}                  (Apply\ \cardinality{r} = 2)\\
      ...
      & = e^{\frac{\epsilon k}{2 S(\dataobs)}} \cdot \cardinality{t} \hexpmechPr{\dataobs}{z = t}         (Apply \ \cardinality{t} = 2)\\
  ...
  \item $\ux{r} = 0, \ux{r} + k \neq 0$. \todo{$r \in \mathcal{R}_1 \land t \in \mathcal{R}_2$}\\
        By $\ux{r} = 0$, $\cardinality{r} = 1$. \todo{By $r \in \mathcal{R}_1$, $\cardinality{t} = 1$}\\
        By $\ux{r} + k = k \neq 0$, $\cardinality{t} = 2$. \todo{By $t \in \mathcal{R}_2$, $\cardinality{t} = 2$}\\
        $\implies$\\
        \begin{equation*}
        \begin{split}
        ...
        & = \cardinality{r} \cdot \frac{exp(\frac{-\epsilon \ux{r}}{2 S(\dataobs)})}{\unomalizer{\dataobs}}
        (Apply\ \ux{r} = \hellinger(\bysinfer(\dataobs), r))\\
        & = \frac{exp(\frac{- \epsilon \ux{r}}{2 S(\dataobs)})}{\unomalizer{\dataobs}}                        (Apply \ \cardinality{r} = 1) \\
  ...
  \item $\ux{r} \neq 0, \ux{r} + k = 0$ \todo{$r \in \mathcal{R}_2 \land t \in \mathcal{R}_1$}\\
      By $\ux{r} + k = 0$, $\cardinality{t} = 1$. \todo{By $t \in \mathcal{R}_1$, $\cardinality{t} = 1$}\\
      By $\ux{r} \neq 0$, $\cardinality{r} = 2$.  \todo{By $r \in \mathcal{R}_2$, $\cardinality{t} = 2$}\\
      $\implies$\\
      \begin{equation*}
      \begin{split}
      LHS   
      ...
      & = 2 \cdot e^{\frac{\epsilon k}{2 S(\dataobs)}} \cdot \cardinality{t} \hexpmechPr{\dataobs}{z = t} (Apply\ \cardinality{t} = 1)\\
  ...
  \item $\ux{r} = 0, \ux{r} + k = 0$: \todo{$r \in \mathcal{R}_1 \land t \in \mathcal{R}_1$}\\
...
\begin{lem}
\label{lem_dilation}
Given $\hexpmech(\dataobs)$ in Beta-binomial system, let $\lambda < |\gamma|$, $\epsilon$, $|\delta'| < 1$ and $\gamma \leq \ln(1 - \frac{\epsilon}{2 \ln (\frac{\delta'}{2 |\candidateset{\dataobs}|})})$, the dilation property holds:
...
Next, we proof the dilation property for $\lambda > 0$, The ratio of $\frac{h(c)}{h(e^{\lambda}c)}$ is $\exp(\frac{\epsilon}{2} \cdot \frac{u(\hexpmech(\dataobs)) (1 - e^{\lambda})}{S(\dataobs)})$. Consider the event $G = \{ \hexpmech(\dataobs) : u(\hexpmech(\dataobs)) \leq \frac{S(\dataobs)}{(1 - e^{\lambda})}\}$. Under this event, the log-ratio above is at most $\frac{\epsilon}{2}$. The probability of $G$ under density $h(c)$ is $1 - \frac{\delta'}{2}$. Thus, the probability of a given event $z$ is at most $Pr[c \cap G] + Pr[\overline{G}] \leq e^{\frac{\epsilon}{2}} Pr[e^{\lambda}c \cap G] + \frac{\delta'}{2} \leq e^{\frac{\epsilon}{2}} Pr[e^{\lambda}c] + \frac{\delta'}{2}$.
  ...
  In Beta-binomial system, $\cardinality{r}$ takes two possible value: $1$, $2$:
  \begin{itemize}
    \item[-] $\cardinality{r} = 1$, $\ux{r} = 0$,  $R_r$ containing only the correct posterior.
    \item[-] $\cardinality{r} = 2$, $\ux{r} \neq 0$. $R_r$ containing 2 elements by the symmetry property of $\hellinger$.
  \end{itemize}
  Let $\ux{t} = e^{\lambda} \ux{r}$, then the proof is given by cases:

  \begin{itemize}
    \item $\ux{r} = 0$:

        By $\ux{r} = 0$, $\cardinality{r} = 1$.\\
        By $\ux{t} = e^{\lambda} \ux{r} = 0$, $\cardinality{t} = 1$.

    \item $\ux{r} \neq 0$:\\
        By $\ux{r} \neq 0$, $\cardinality{r} = 2$.\\
        By $\ux{t} = e^{\lambda} \ux{r} \neq 0$, $\cardinality{t} = 2$.
        ...
        \begin{equation*}
        \cardinality{r} \cdot \hexpmechPr{\dataobs}{z = r}
        \leq
        e^{\frac{\epsilon}{2}} \cardinality{t} \cdot \hexpmechPr{\dataobs}{z = t}
        \end{equation*}
        holds with failure probability $\frac{\delta'}{2}$.

        By $\cardinality{t} = \cardinality{r} = 2$, we need to show:
        \begin{equation*}
...
\begin{proof} of Lemma \ref{lem_hexpmech_privacy}.
  ...
  \end{equation*}
   ...
   In Beta-binomial system, $\cardinality{r}$ takes two possible value: $1$, $2$, when considering data set $\dataobs$:
  \begin{itemize}
    \item[*] $\cardinality{r} = 1$, $\ux{r} = 0$,  $R_r$ containing only the correct posterior.
    \item[*] $\cardinality{r} = 2$, $\ux{r} \neq 0$. $R_r$ containing 2 elements by the symmetry property of $\hellinger$.
  \end{itemize}
  ...
  \begin{itemize}
    \item[*] $\cardinality{r} = 1$, $\uxadj{r} = 0$,  $R_r$ containing only the correct posterior.
    \item[*] $\cardinality{r} = 2$, $\uxadj{r} \neq 0$. $R_r$ containing 2 elements by the symmetry property of $\hellinger$.
  \end{itemize}
  ...
  \begin{itemize}
    ...
    By $\ux{r} \neq 0$, $\cardinality{r} = 2$ under data set $\dataobs$.

      Apply \ Lemma\ \ref{lem_score_pro_convert}:  
      \begin{equation*}
      \hexpmechPr{\dataobs}{z = r} = \frac{1}{\cardinality{r}} \hexpmechPr{\dataobs}{\ux{z} = \ux{r}}.
      \end{equation*}

      Apply \ Lemma\ \ref{lem_sliding}:
      \begin{equation*}
      \begin{split}
      & = \frac{1}{\cardinality{r}} \Big( e^{(\frac{\epsilon (\uxadj{r} - \ux{r})}{2 S(\dataobs)} + \ln 2)} \hexpmechPr{\dataobs}{\ux{z} = \ux{r} + (\uxadj{r} - \ux{r})} \Big)\\
      & = \frac{1}{\cardinality{r}} \Big( e^{(\frac{\epsilon (\uxadj{r} - \ux{r})}{2 S(\dataobs)} + \ln 2)} \hexpmechPr{\dataobs}{\ux{z} = \uxadj{r} } \Big).
      \end{split}
      \end{equation*}
      ...
      \begin{equation*}
      \begin{split}
      & = \frac{1}{\cardinality{r}} \Big( e^{(\frac{\epsilon (\uxadj{r} - \ux{r})}{2 S(\dataobs)} + \ln 2)} 
      ...
      & = \frac{1}{\cardinality{r}} \Big( e^{(\frac{\epsilon (\uxadj{r} - \ux{r})}{2 S(\dataobs)} + \ln 2)} 
      \big( e^{\frac{\epsilon}{2}}
      \cardinality{t} \cdot \hexpmechPr{\dataobs}{z = t } \\
      & + 1 - |\candidateset{\dataobs}|exp(\frac{\epsilon}{2 (1 - e ^ {\ln(\frac{S(\dataobs)}{S(\dataobs')} \ln(\frac{NL(\dataobs)}{NL(\dataobs')}))})}) 
      \big ) \Big).
      \end{split}
      \end{equation*}

      Apply $\uxadj{r} \neq 0 \implies \ux{t} \neq 0 \implies \cardinality{t} = 2$.\\
      Apply  $\cardinality{r} = 2$ and  $\cardinality{t} = 2$:\\
      \begin{equation*}
      \begin{split}
      & = \frac{1}{2} \Big( e^{(\frac{\epsilon (\uxadj{r} - \ux{r})}{2 S(\dataobs)} + \ln 2)} 
      \big( e^{\frac{\epsilon}{2}} 2 \hexpmechPr{\dataobs}{z = t} \\
      & + 1 - |\candidateset{\dataobs}|exp(\frac{\epsilon}{2 (1 - e ^ {\ln(\frac{S(\dataobs)}{S(\dataobs')} \ln(\frac{NL(\dataobs)}{NL(\dataobs')}))})}) 
      \big ) \Big)\\
      \end{split}
      \end{equation*} 

      Apply Definition \ref{def_smoo} and $\ux{t} = \hellinger(\bysinfer(\dataobs),t)$:
      \begin{equation*}
      \begin{split}          
      & = \frac{1}{2} \Big( e^{(\frac{\epsilon (\uxadj{r} - \ux{r})}{2 S(\dataobs)} + \ln 2)} 
      \big( e^{\frac{\epsilon}{2}}
      2  \frac{exp(\frac{-\epsilon (\ux{t})}{2 S(\dataobs)})}{\unomalizer{\dataobs}}\\
      & + 1 - |\candidateset{\dataobs}|exp(\frac{\epsilon}{2 (1 - e ^ {\ln(\frac{S(\dataobs)}{S(\dataobs')} \ln(\frac{NL(\dataobs)}{NL(\dataobs')}))})}) 
      \big ) \Big)
      \end{split}
      \end{equation*}
      ...
      & = \frac{1}{2} \Big( e^{(\frac{\epsilon (\uxadj{r} - \ux{r})}{2 S(\dataobs)} + \ln 2)} 
      \big( e^{\frac{\epsilon}{2}}
      2 \frac{exp(\frac{-\epsilon (\uxadj{r})}{2 S(\dataobs')})}{\unomalizer{\dataobs'}}\\
      & + 1 - |\candidateset{\dataobs}|exp(\frac{\epsilon}{2 (1 - e ^ {\ln(\frac{S(\dataobs)}{S(\dataobs')} \ln(\frac{NL(\dataobs)}{NL(\dataobs')}))})}) 
      \big ) \Big)\\
       \end{split}
      \end{equation*}
      ...
      & = \frac{1}{2} \Big( e^{(\frac{\epsilon (\uxadj{r} - \ux{r})}{2 S(\dataobs)} + \ln 2)} 
      \big( e^{\frac{\epsilon}{2}}
      2  \hexpmechPr{\dataobs'}{z = r}
      + 1 - |\candidateset{\dataobs}|exp(\frac{\epsilon}{2 (1 - e ^ {\ln(\frac{S(\dataobs)}{S(\dataobs')} \ln(\frac{NL(\dataobs)}{NL(\dataobs')}))})}) 
      \big ) \Big)\\
      & = e^{(\frac{\epsilon (\uxadj{r} - \ux{r})}{2 S(\dataobs)} + \ln 2)} \cdot e^{\frac{\epsilon}{2}}
      \hexpmechPr{\dataobs'}{z = r} \\
      & + \frac{e^{(\frac{\epsilon (\uxadj{r} - \ux{r})}{2 S(\dataobs)} + \ln 2)}}{2}
      \Big( 1 - |\candidateset{\dataobs}|exp(\frac{\epsilon}{2 (1 - e ^ {\ln(\frac{S(\dataobs)}{S(\dataobs')} \ln(\frac{NL(\dataobs)}{NL(\dataobs')}))})}) \Big)\\
      \end{split}
      \end{equation*}

      Then, $\hexpmech$ is $(\epsilon', \delta)-$differential privacy where $\epsilon = e^{(\frac{\epsilon (\uxadj{r} - \ux{r})}{2 S(\dataobs)} + \ln 2)} \cdot e^{\frac{\epsilon}{2}}$, and
      $\delta = \frac{e^{(\frac{\epsilon (\uxadj{r} - \ux{r})}{2 S(\dataobs)} + \ln 2)}}{2}
      \Big( 1 - |\candidateset{\dataobs}|exp(\frac{\epsilon}{2 (1 - e ^ {\ln(\frac{S(\dataobs)}{S(\dataobs')} \ln(\frac{NL(\dataobs)}{NL(\dataobs')}))})}) \Big)$.

    \item $\ux{r} = 0$, $\uxadj{r} \neq 0$:
    \item $\ux{r} \neq 0$, $\uxadj{r} = 0$:
    \item $\ux{r} = 0$, $\uxadj{r} = 0$:
  \end{itemize}

	\begin{equation*}
	\begin{split}
	\hexpmechPr{\dataobs}{z = r}
	& = 	\frac{1}{|z|}\Big( \hexpmechPr{\dataobs}{ u(z, \dataobs) = U}\Big)\\
	& \leq 	\frac{1}{|z|}\Big( e^{\epsilon / 2} \cdot \hexpmechPr{\dataobs}{u(z, \dataobs) = U_2}\Big)\\
	& \leq 	\frac{1}{|z|}\Big( e^{\epsilon} \cdot \hexpmechPr{\dataobs}{u(z, \dataobs) = U_3} + e^{\epsilon/2} \cdot \frac{\delta'}{2}\Big)\\
