...
\begin{itemize}
  \item[-] The $\hexpmech$ outperforms asymptotically the baseline 
  approach but not the improved one.
  \item[-] By increasing the prior, $\hexpmech$ can outperform LapMech under small data set size.
  % \begin{enumerate}
