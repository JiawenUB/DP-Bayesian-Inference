...
\begin{thm}
 ...
 $$ 
 and $|z| = \frac{k! k!}{|a_1|! |a_2|! \cdots |a_{k_a}|! \cdot |b_1|! |b_2|! \cdots |b_{k_b}|!}$, where $\sum{|a_i|} = \sum{|b_i|} = k$.
 \end{thm}
 ...
 Then, there are $\frac{k! k!}{|a_1|! |a_2|! \cdots |a_{k_a}|! \cdot |b_1|! |b_2|! \cdots |b_{k_b}|!}$ possible permutation when the condition in Theorem \ref{thm_hellinegr_equality_dirichlet} is satisfied.
 \end{proof}
