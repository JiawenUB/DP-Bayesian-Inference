...
In this work we explore the design space for differentially private Bayesian
inference.  We focus on two discrete models for parametric Bayesian
...
a scoring function based on a metric over probabilistic measures, i.e.,
