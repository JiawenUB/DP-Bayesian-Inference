...
As already mentioned $\expmech, \lexpmech, \sexpmech$ extends straightforwardly to the Dirichlet-multinomial system.
...
that $\candidateset$ has $\binom{n + 1}{m - 1}$ elements in this case. {\color{red}{what is m here?}}
