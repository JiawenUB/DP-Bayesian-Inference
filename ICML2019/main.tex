...
\begin{lem}
\[
LS(\dataobs) = \max_{\dataobs' \in \datauni^n:\adj{\dataobs}{\dataobs'}} \hellinger(\bysinfer(\dataobs), \bysinfer(\dataobs')).
\]
\end{lem}
...
In this section, we fix $\alpha$ and $\beta$.
For simplicity, for any integer $t$, we write
$
...
\begin{align*}
 ...
 & \qquad = 0.19673467 \text{ or } 0.316060279,\\
%\end{align*}
%  \]
...
%\begin{align*}
  ...
  & \qquad = 0.119325609 \text{ or } 0.116272079,\\
%\end{align*}
...
%\begin{align*}
 ...
 & \qquad = 0.072374641 \text{ or }  0.042774107
%\]
\end{align*}
