...
\newcommand{\zlapmech}{\mathsf{LSZhang}}
...
\newcommand{\bigo}[1]{\mathcal{O}\bigg( #1 \bigg)}
...
\newcommand{\uniform}[2]{\mathsf{uniform}(#1, #2)}
...
\newcommand{\jiawen}[1]{{\small \color{blue}\textbf{[[Jiawen: #1 ]]}}}
