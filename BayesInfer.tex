...
\frac{\frac{n}{2} + 1 + \frac{n}{2} + 1 - 1}{2})}
{\sqrt{
\mathsf{beta}(\frac{n}{2} + 1, \frac{n}{2} + 1)
\mathsf{beta}(\frac{n}{2} + 1 + 1, \frac{n}{2} + 1 - 1)
}
}
}
& < \sqrt{1 - \frac{\mathsf{beta}(
...
{\sqrt{
\mathsf{beta}(\frac{n}{2} + 1 + 1, \frac{n}{2} + 1 - 1)
\mathsf{beta}(\frac{n}{2} + 1 + 2, \frac{n}{2} + 1 - 2)
}
}
}\\
...
{\sqrt{
\mathsf{beta}(\frac{n}{2} + 1, \frac{n}{2} + 1)
\mathsf{beta}(\frac{n}{2} + 2, \frac{n}{2})
}
}
}
...
{\sqrt{
\mathsf{beta}(\frac{n}{2} + 2, \frac{n}{2})
\mathsf{beta}(\frac{n}{2} + 3, \frac{n}{2} - 1)
}
}
}\\
...
& > \frac{
\mathsf{beta}(\frac{n + 3}{2}, \frac{n - 1}{2}) 
